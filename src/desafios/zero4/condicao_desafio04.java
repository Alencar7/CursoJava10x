...
public class condicao_desafio04 {
    /*
    DESAFIO:
    ...
    /*
        DESAFIO EXTRA!
     Defina um enum chamado TipoHabilidade com diferentes tipos de
    habilidades como TAIJUTSU, NINJUTSU, GENJUTSU, KATON, e RINNENGAN. \
    Utilize esse enum nas classes NinjaBásico e NinjaAvançado para representar o tipo de habilidade de cada
    ninja.
     */

    /*
    PASSO A PASSO:
        -   Cria a interface Ninja que vai ser implementada por todas
            as outras
        -   Crie as classes NinjaBásico e NinjaAvancado implementando
            a interface
        -   Crie um atributo na classe avancada chamado especialidade
        -   Adicione um construtor para inicializar esses atributos e
            implemente os métodos da interface para mostrar as informações
            e executar a habilidade.
     */
